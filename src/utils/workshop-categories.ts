...
export const workshopFolders = [
  "AQUÁRIO",
  "OFICINA DE ARCO DISNEY",
  "OFICINA DE ASA DE BORBOLETA",
  "OFICINA DE BELEZA",
  "OFICINA DE BIJU",
  "OFICINA DE BISCOITOS DECORADOS",
  "BISCUIT",
  "OFICINA DE BODYS DE BEBÊ",
  "OFICINA DE BOLHAS DE SABAO",
  "OFICINA DE BOLSAS DE PALHA",
  "OFICINA DE BONE",
  "BRINCADEIRAS RAIZ",
  "BRINQUEDOTECA",
  "OFICINA DE BUCKET",
  "OFICINA DE CADERNINHOS",
  "CAIXA DE FADA",
  "OFICINA DE CAMISAS",
  "CAPA HARRY POTTER",
  "OFICINA DE CAPA DE SUPER-HERÓI",
  "CARMED",
  ...
  "CHAPEU DE PALHA",
  "CIENTISTA",
  "OFICINA DE COLAGEM E CRIATIVIDADE",
  "OFICINA DE CUPCAKE",
  "OFICINA DE ESMALTAÇAO",
  "ESPAÇO SONINHO",
  "OFICINA DE ESTOJO",
...
export const foldersWithSubfolders = {
  BRINQUEDOTECA: ["CLEAN", "COLORIDA", "PRINCESAS"],
};
