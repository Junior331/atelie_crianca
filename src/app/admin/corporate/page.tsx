...
const GALLERY_STRUCTURE: ImageSlot[] = [
  {
    id: "corporate_01",
    key: "corporate_foto_01",
    currentImage: getImage("fallback").src,
    colSpan: "md:col-span-2",
  },
  {
    id: "corporate_02",
    key: "corporate_foto_02",
    currentImage: getImage("fallback").src,
  },
  {
    id: "corporate_03",
    key: "corporate_foto_03",
    currentImage: getImage("fallback").src,
  },
  {
    id: "corporate_04",
    key: "corporate_foto_04",
    currentImage: getImage("fallback").src,
    colSpan: "md:col-span-2",
  },
  {
    id: "corporate_05",
    key: "corporate_foto_05",
    currentImage: getImage("fallback").src,
    colSpan: "md:col-span-2",
  },
  {
    id: "corporate_06",
    key: "corporate_foto_06",
    currentImage: getImage("fallback").src,
  },
];
...
export default function CorporateAdmin() {
  ...
  const [imageSlots, setImageSlots] = useState<ImageSlot[]>([
    {
      ...
      currentImage: getImage("capa_corporativo").src,
      isBanner: true,
      width: 1200,
      height: 500,
    },
        ...
        prev.map((s) => {
          if (s.id === slot.id) {
            ...
            return defaultSlot
              ...
              : { ...s, currentImage: getImage("capa_corporativo").src };
          }
          return s;
        })
      );
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      {/* Content - Espelhando o layout do corporate */}
            ...
            .map((slot) => (
              <div key={slot.id} className="mb-8">
                ...
                <div className="relative">
                  <div
                    className="relative w-full h-auto max-h-[640px] flex items-center justify-center cursor-pointer group"
